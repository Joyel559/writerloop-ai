...
const primaryButtonClass = 'rounded-xl bg-gradient-to-r from-[#157a6e] to-[#f2994a] px-4 py-2 font-medium text-white shadow-[0_18px_34px_-18px_rgba(21,122,110,0.82)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_20px_38px_-16px_rgba(21,122,110,0.78)] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#157a6e]/25';
      ...
      <AnimatePresence>
        {showUploadModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              <div className="absolute left-0 top-0 h-1.5 w-full bg-gradient-to-r from-[#157a6e] to-[#f2994a]" />
              ...
              <motion.p initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.2, delay: 0.06 }} className="mb-8 leading-relaxed text-slate-500">Import your favorite stories in PDF, EPUB, CBZ, TXT, or MD format.</motion.p>
              ...
              <div
                ...
                className={cn(
                  ...
                  isDragActive ? 'scale-[1.01] border-[#f2994a] bg-[#157a6e]/5' : 'border-slate-200 hover:border-[#f2994a]/50 hover:bg-slate-50'
                )}
              >
                <input {...getInputProps()} />
                <div
                  className={cn(
                    ...
                    isDragActive ? 'bg-gradient-to-r from-[#157a6e] to-[#f2994a] text-white shadow-[#157a6e]/30' : 'bg-white text-[#157a6e] shadow-slate-200/70'
                  )}
                >
                  <Upload className="h-8 w-8" />
                </div>
                <p className="mb-2 text-xl font-bold text-slate-900">Click or drag files here</p>
                <p className="mx-auto max-w-xs text-sm leading-relaxed text-slate-400">Supports EPUB, PDF, CBZ, Markdown, and Text files.</p>
              </div>
            </motion.div>
          </div>
        )}
      ...
      <AnimatePresence>
        {bookToEdit && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              <div className="border-b border-slate-100/90 bg-gradient-to-r from-white to-[#157a6e]/[0.04] p-5">
              ...
              <div className="space-y-4 overflow-y-auto p-5">
                ...
                <div className="flex flex-wrap gap-2">
                  <label className="inline-flex cursor-pointer items-center gap-2 rounded-xl border border-slate-200 px-3 py-2 text-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-[#f2994a]/40 hover:bg-[#157a6e]/5 active:scale-[0.98]" title="Change Cover">
                    <ImagePlus className="h-4 w-4 text-[#157a6e]" />
                    Change Cover
                    <input
                      type="file"
                      className="hidden"
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-300/90 px-3 py-2.5 transition-all focus:border-[#f2994a]/40 focus:outline-none focus:ring-4 focus:ring-[#157a6e]/10"
                  placeholder="Title"
                  title="Book Title"
                />
                <input
      ...
      <AnimatePresence>
        {categoryToRename && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              <div className="border-b border-slate-100 bg-gradient-to-r from-white to-[#157a6e]/[0.05] px-6 py-5">
              ...
              <div className="p-6">
                <input
                  ...
                  className="mb-6 w-full rounded-xl border border-slate-300/90 px-3 py-2.5 transition-all focus:border-[#f2994a]/40 focus:outline-none focus:ring-4 focus:ring-[#157a6e]/10"
                />
                <div className="flex gap-3">
            ...
            >
              ...
              <div className="p-6">
                <div className="mb-6 space-y-3">
                  <label className={cn('flex cursor-pointer items-center rounded-xl border p-3 transition-all duration-200 hover:-translate-y-0.5 active:scale-[0.99]', deleteCategoryMode === 'keep-books' ? 'border-[#f2994a] bg-[#157a6e]/5' : 'border-slate-200 hover:bg-slate-50')}>
