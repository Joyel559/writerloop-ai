...
import { BookMarked, BookOpen, Check, Edit2, FileCode2, FileText, Globe, Highlighter, Images, MoreVertical, NotebookPen, Plus, Pin, Trash2 } from 'lucide-react';
    ...
    switch (bookType) {
      case 'pdf':
        return {
          ...
          glowClassName: 'from-[#157a6e]/35 via-[#f2994a]/15 to-transparent',
        };
      case 'epub':
        return {
          label: 'EPUB',
  ...
  return (
    <main className="mx-auto max-w-7xl px-6 py-10 space-y-10">
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        >
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_20%_0%,rgba(242,153,74,0.14)_0%,rgba(242,153,74,0)_45%)]" />
          <div className="pointer-events-none absolute right-0 top-0 h-32 w-32 translate-x-10 -translate-y-10 rounded-full bg-[#f2994a]/20 blur-2xl" />

          <div className="relative z-10 flex min-h-[220px] flex-col justify-between">
            <div>
              <div className="mb-3 flex flex-wrap items-center gap-2">
                <p className="inline-flex items-center rounded-full border border-[#157a6e]/20 bg-[#157a6e]/5 px-3 py-1 text-xs font-semibold tracking-wide text-[#157a6e]">
                  LIBRARY HOME
                </p>
                <span className="inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3 py-1 text-[11px] font-medium text-slate-500">
                  <span className="h-2 w-2 rounded-full bg-[#f2994a] animate-pulse" />
                  Focus mode ready
                </span>
              </div>
              <h2 className="max-w-3xl text-3xl font-serif font-bold leading-[1.08] tracking-[-0.015em] text-slate-900 md:text-4xl">
                {recentBook ? (
                  <>
                    Continue reading{' '}
                    <span className="bg-gradient-to-r from-[#157a6e] to-[#f2994a] bg-clip-text text-transparent">
                      “{recentBook.title}”
                    </span>
                  </>
                ) : (
                  <>
                    Build your
                    <span className="bg-gradient-to-r from-[#157a6e] to-[#f2994a] bg-clip-text text-transparent"> modern reading library</span>
                  </>
                )}
              </h2>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              {recentBook && (
                <motion.button
                  ...
                  className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-[#157a6e] to-[#f2994a] px-5 py-3 text-sm font-semibold text-white shadow-[0_16px_34px_-18px_rgba(21,122,110,0.8)] transition-all duration-300 hover:shadow-[0_24px_42px_-18px_rgba(21,122,110,0.75)] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#157a6e]/25"
                >
              ...
              <motion.button
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-sea/30 bg-white/90 px-5 py-3 text-sm font-semibold text-ink shadow-[0_14px_30px_-20px_rgba(21,32,51,0.28)] backdrop-blur transition-all duration-300 hover:border-sea/50 hover:bg-white focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-sea/20"
              >
        ...
        >
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_80%_0%,rgba(242,153,74,0.35)_0%,rgba(242,153,74,0)_48%)]" />
          <div className="relative z-10 flex h-full flex-col justify-between">
            ...
            <div className="space-y-5">
              ...
              <div>
                <p className="bg-gradient-to-r from-[#157a6e] to-[#f2994a] bg-clip-text text-4xl font-serif font-bold leading-none text-transparent">
                  {categoriesUsedCount}
                </p>
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="space-y-1">
            ...
            <select
              ...
              className="w-full min-w-[220px] rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm font-medium text-slate-700 outline-none transition-all duration-200 focus:border-[#f2994a] focus:ring-4 focus:ring-[#157a6e]/10"
            ...
            {selectedCategory && (
              <div className="mr-1 flex items-center gap-1 border-r border-slate-200 pr-3">
                <button
                  ...
                  className="rounded-full p-2 text-slate-400 transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#157a6e]/10 hover:text-[#157a6e] active:scale-95 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#157a6e]/20"
                  title="Rename shelf"
            ...
            {showCategoryInput ? (
              <div className="flex items-center rounded-full border border-slate-200 bg-white px-1 py-0.5">
                ...
                <button
                  ...
                  className="rounded-full bg-gradient-to-r from-[#157a6e] to-[#f2994a] p-1.5 text-white transition-all duration-200 hover:-translate-y-0.5 hover:opacity-90 active:scale-95 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#157a6e]/25"
                  title="Create shelf"
      ...
      <div className="space-y-5">
        <div className="flex flex-wrap items-center gap-3">
          ...
          {selectedCategory && (
            <span className="inline-flex items-center rounded-full border border-[#157a6e]/20 bg-[#157a6e]/5 px-3 py-1 text-xs font-semibold text-[#157a6e]">
        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-10 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
          <AnimatePresence mode="popLayout">
            ...
            return (
              ...
              >
                <div className="relative aspect-[2/3] w-full overflow-hidden rounded-2xl border border-slate-200/90 bg-slate-100 shadow-[0_16px_34px_-20px_rgba(15,23,42,0.55)] transition-all duration-400 group-hover:border-[#f2994a]/35 group-hover:shadow-[0_24px_44px_-22px_rgba(15,23,42,0.52)]">
                  ...
                  {book.isPinned && (
                    <div className="absolute left-2 top-2 z-10 inline-flex items-center gap-1 rounded-full border border-[#f2994a]/35 bg-[#0F172A]/65 px-2.5 py-1 text-[10px] font-semibold text-white backdrop-blur-md">
                  ...
                  <div className="absolute right-2 top-2 translate-y-1 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
                    <button
                      ...
                      className="rounded-full bg-white/92 p-2 text-slate-800 shadow-sm transition-all hover:scale-105 hover:bg-white focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#157a6e]/25"
                    >
                  ...
                  {typeof book.progress === 'number' && book.progress > 0 && (
                    <div className="absolute bottom-0 left-0 right-0 h-1 bg-black/25">
                      <motion.div
                        className="h-full bg-gradient-to-r from-[#157a6e] to-[#f2994a]"
                        initial={{ width: 0 }}
                ...
                <div className="mt-4 space-y-2 transition-transform duration-300 group-hover:-translate-y-0.5">
                  <div className="flex flex-wrap items-center gap-2">
                    <span className={cn('inline-flex items-center gap-1 rounded-full border px-2.5 py-1 text-[11px] font-semibold', typeMeta.chipClassName)}>
                      <TypeIcon className="h-3.5 w-3.5 text-[#157a6e]" />
                      {typeMeta.label}
                    </span>
                    {book.type === 'web' && getWebDomain(book) && (
                      <span className="inline-flex items-center rounded-full border border-[#157a6e]/20 bg-[#157a6e]/5 px-2.5 py-1 text-[11px] font-medium text-[#157a6e]">
                        {getWebDomain(book)}
                      </span>
                    )}
                  </div>

                  <h3 className="line-clamp-2 font-serif text-[17px] font-bold leading-tight text-slate-900 transition-all duration-200 group-hover:text-[#157a6e]">
                    {book.title}
                  </h3>
                  ...
                  >
                    <div className="p-1.5">
                      <button
                        ...
                        className="flex w-full items-center gap-2.5 rounded-xl px-3 py-2.5 text-left text-sm font-medium text-slate-700 transition-all duration-200 hover:-translate-y-0.5 hover:bg-slate-50 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#157a6e]/20"
                      >
                      ...
                      <button
                        ...
                        className="flex w-full items-center gap-2.5 rounded-xl px-3 py-2.5 text-left text-sm font-medium text-slate-700 transition-all duration-200 hover:-translate-y-0.5 hover:bg-slate-50 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#157a6e]/20"
                      >
                        <Pin className={cn('h-4 w-4', book.isPinned ? 'fill-current text-[#157a6e]' : 'text-slate-400')} />
                    ...
                    <div className="max-h-60 overflow-y-auto p-1.5">
                      {categories.map((cat) => (
                        <button
                          ...
                          className={cn(
                            'flex w-full items-center justify-between rounded-xl px-3 py-2 text-left text-sm transition-all duration-200 hover:-translate-y-0.5 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#157a6e]/20',
                            book.category === cat.name ? 'bg-[#157a6e]/8 font-medium text-[#157a6e]' : 'text-slate-600 hover:bg-slate-50'
                          )}
                        >
                      ...
                      {book.category && (
                        <button
                          ...
                          className="mt-1 w-full rounded-xl px-3 py-2 text-left text-sm text-slate-500 transition-all duration-200 hover:-translate-y-0.5 hover:bg-slate-50 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#157a6e]/20"
                        >
                          Uncategorized
                        </button>
                      )}
        ...
        {filteredBooks.length === 0 && !loading && (
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={onShowUpload}
              className="rounded-full bg-gradient-to-r from-[#157a6e] to-[#f2994a] px-6 py-2.5 text-sm font-semibold text-white shadow-[0_16px_34px_-18px_rgba(21,122,110,0.8)] transition-all hover:opacity-95 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#157a6e]/25"
            >
              Add your first book
            </motion.button>
          </motion.div>
