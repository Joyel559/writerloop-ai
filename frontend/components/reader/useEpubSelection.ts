...
const ACTIVE_THEME_NAME = 'writerloop-reader-active-theme';
const CONTENT_STYLE_ID = 'writerloop-reader-force-theme-style';
const MENU_GAP = 12;
...
const applyContentThemeStyle = (doc: Document | null | undefined, theme: Theme) => {
  if (!doc?.head) return;
